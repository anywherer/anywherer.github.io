...
a point on the [[unit circle , trig function|unit circle]] that corresponds to an angle $\theta$ must have the coordinates $(\cos(\theta),\sin(\theta))$
